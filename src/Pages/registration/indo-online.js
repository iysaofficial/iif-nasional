...
function IndonesiaOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Invention and Innovation Fair - Kompetisi Daring":
  ...
  useEffect(() => {
    ...
    if (!termsAccepted) {
      ...
      navigate.push("/homeindo"); // Navigasi ke halaman HomeIndo
    }
  }, [navigate]);

  const scriptURL =
    "https://script.google.com/macros/s/AKfycbwFR21R20CMw2lEBjlo94dS0OKxKJ-YzopYTG74PnRov8h8zmno7a4_03QMxZ-F2c98/exec";
      ...
      <div className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HALLO PESERTA IIF 2026, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="Invention and Innovation Fair - Kompetisi Daring">
                      Kompetisi Daring
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  <label>
                    ...
                    <h6>Pangeran Hasanudin Genggong</h6>
                    <h6>Irsyad Zaidan Kusuma Adi Ningrat</h6>
                  </label>
                  <textarea
                    type="text"
                    id="NAMA_LENGKAP"
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi IIF 2026
                  </label>
                  <select
                    type="text"
                  ...
                  >
                    ...
                    <option value="IIF Website">IIF Website</option>
                    <option value="IYSA Website">IYSA Website</option>
                    <option value="IYSA Instagram">IYSA Instagram</option>
                    <option value="IIF Instagram">IIF Instagram</option>
                    ...
                    <option value="IIF Email">IIF Email</option>
